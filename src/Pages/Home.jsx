        ...
        {loading ? (
          ...
          <>
            ...
            <div className="text-center font-bold">
              <span onClick={onBackwardClick}><i className="fa-solid fa-backward me-3 cursor-pointer"></i></span>
              <span className="me-3">{currentPage} of {totalPage}</span>
              <span onClick={onForwardClick}><i className="fa-solid fa-forward me-3 cursor-pointer"></i></span>
